...
import { RequestTeams } from './requestTeams.js';
...
Team.hasMany(RequestTeams, { foreignKey: 'team_id', sourceKey: 'id' });
RequestTeams.belongsTo(Team, { foreignKey: 'team_id', targetKey: 'id' });
